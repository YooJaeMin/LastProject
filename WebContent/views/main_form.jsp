			...
			<form action="/search/keyword" method="get">
				<div class="col-md-10">
					<input type="text" name="keyword" class="form-control"
						style="height: 55px; font-size: 18px; border: 4px solid; border-color: #ff9400;"
						placeholder="검색어 입력! 예) 강남역 수요미식회">
				</div>
				<div class="input-group-btn col-md-2">
					<button class="btn btn-default" type="submit"
						style="height: 55px; width: 120px; font-size: 18px; border: 4px solid; border-color: #ff9400; background-color: #ff9400; color: white;">
						<span>←</span>
					</button>
				</div>
			</form>
