...
<!-- naverLogn  -->
<script type="text/javascript">
	var naver_id_login = new naver_id_login("tsbCd7wyhckg0AQ8seVR",	"http://192.168.10.21/nav2_finished.jsp");		//돌아오는 url 
