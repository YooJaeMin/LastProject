...
<h3><b>개인정보 취급 방침</b></h3><br />
본 방침은부터 2014년 11월 5일부터 적용됩니다.<br />
<br />
다이닝코드(이하 ‘당사’라함)이 소유하고 운영하는 다이닝코드 어플리케이션과 이와 관련된 웹사이트들(이하 ‘다이닝코드’라 함)은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br />
<br />
...
1) 쿠키의 사용 목적 : 다이닝코드의 각 서비스와 방문형태 및 좋아요한맛집 등을 파악하여 이용자에게 최적화된 정보 제공을 위하여 사용합니다.<br />
2) 쿠키의 설치/운영 및 거부<br />
- 이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는 웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수도 있습니다.<br />
- 다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 다이닝코드의 일부 서비스 이용에 어려움이 있을 수 있습니다. <br />
